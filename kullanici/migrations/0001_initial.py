...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'kullanici', ['Member'])

        # Adding model 'Wallet'
        db.create_table(u'member_wallet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kullanici', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.Member'])),
        ))
        db.send_create_signal(u'kullanici', ['Wallet'])
        ...
        db.send_create_signal(u'kullanici', ['Category'])

        # Adding model 'On_Sales'
        db.create_table(u'member_on_sales', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kullanici', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.Member'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.Category'])),
        ...
        db.send_create_signal(u'kullanici', ['On_Sales'])

        # Adding model 'Orders'
        db.create_table(u'member_orders', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('on_sales', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.On_Sales'])),
            ('ship_to_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.Member'])),
        ...
        db.send_create_signal(u'kullanici', ['Orders'])

        # Adding model 'After_Sale'
        db.create_table(u'member_after_sale', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orders', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kullanici.Orders'])),
            ('status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('cdate', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'kullanici', ['After_Sale'])
        ...
        db.send_create_signal(u'kullanici', ['City'])
    ...
    models = {
        u'kullanici.after_sale': {
            ...
            'orders': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kullanici.Orders']"}),
        ...
        u'kullanici.orders': {
            ...
            'ship_to_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kullanici.Member']"}),
            'status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        u'kullanici.wallet': {
